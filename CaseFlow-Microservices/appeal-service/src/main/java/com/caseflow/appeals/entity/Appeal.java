...
public class Appeal {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Long appealId;
    @Column(nullable = false) private Long caseId;
    @Column(nullable = false) private Long filedByUserId;
    @Column(nullable = false) private LocalDate filedDate;
    ...
    public enum AppealStatus { SUBMITTED, REVIEWED, DECIDED }
}
